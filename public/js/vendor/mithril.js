...
var _20 = function(renderer, pubsub) {
...
m.mount = _20(renderService, redrawService)
var mount = m.mount
...
var _26 = function($window, mount0) {
	...
	var route = function(root, defaultRoute, routes) {
		...
		router.defineRoutes(routes, function(payload, args0, path) {
			...
			if (isResolver) {
				if (typeof payload.render === "function") render2 = payload.render.bind(payload)
...
m.Component = renderService.Component
